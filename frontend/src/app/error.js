...
export default function Error({ error, reset }) {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center">
      <p className="text-sm font-medium text-gray-400 tracking-widest mb-2">Greška</p>
      <h1 className="text-3xl font-bold text-gray-900 mb-3">Nešto je pošlo po zlu</h1>
