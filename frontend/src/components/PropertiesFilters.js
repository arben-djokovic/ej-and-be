        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="flex justify-end gap-3 mt-6">
                <div className="cursor-pointer shadow-lg border border-gray-200 rounded-lg gap-2 py-2 px-3 flex items-center text-sm hover:shadow-xl">
              ...
              <Button
                ...
                onClick={handleReset}
              >
                <div className="gap-2 py-2 px-3 flex items-center text-sm ">
